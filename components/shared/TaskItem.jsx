  ...
  return (
    <div className="flex flex-col gap-6">
      <Wrapper
        {...(onToggle ? { htmlFor: id } : {})}
        className={cn(
          "flex items-center gap-3 rounded-lg border-2 p-3 has-[[aria-checked=true]]:border-green-600 has-[[aria-checked=true]]:bg-green-50 dark:has-[[aria-checked=true]]:border-green-700 dark:has-[[aria-checked=true]]:bg-green-900 cursor-pointer transition duration-300",
